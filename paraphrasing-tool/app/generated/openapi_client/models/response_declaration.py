...
class ResponseDeclaration(BaseModel):
    ...
    base_type: StrictStr
    correct_response: List[StrictStr]
    __properties: ClassVar[List[str]] = ["identifier", "cardinality", "base_type", "correct_response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "correct_response": obj.get("correct_response")
        })
        return _obj
